/**
 * ═══════════════════════════════════════════════════════════════
 *  SUNUM ÇUBUĞU — Bursa Kozalak Anaokulu tasarım demosu
 * ═══════════════════════════════════════════════════════════════
...
(function () {
  ...
  var TASARIMLAR = [
    { no: 1, ad: 'Orman',    dosya: '/kozalak-demo/' },
    { no: 2, ad: 'Atölye',   dosya: '/kozalak-demo/tasarim-2.html' },
    { no: 3, ad: 'Bahçe',    dosya: '/kozalak-demo/tasarim-3.html' },
    { no: 4, ad: 'Kemer',    dosya: '/kozalak-demo/tasarim-4.html' },
    { no: 5, ad: 'Dergi',    dosya: '/kozalak-demo/tasarim-5.html' },
    { no: 6, ad: 'Yolculuk', dosya: '/kozalak-demo/tasarim-6.html' }
  ];
  ...
  var PALETLER = [
    ...
    { id:'cam', ad:'Kozalak Ormanı', not:'Çam yeşili + terrakota',
  ...
  var A_PALET = 'kozalak_palet', A_KAPALI = 'kozalak_cubuk_kapali',
      A_BOLUM = 'kozalak_bolum', A_IPUCU = 'kozalak_ipucu';
...
'.kozalak-logo-img{display:block;height:100%;width:auto;max-height:100%}',
...
'@media (prefers-reduced-motion:reduce){#sc,#scAlt{transition:none}}'
  ...
  function logoYerlestir(){
    Array.prototype.forEach.call(document.querySelectorAll('[data-logo]'), function (yuva) {
      var img = new Image();
      img.alt = 'Bursa Kozalak Anaokulu';
      img.className = 'kozalak-logo-img';
      img.decoding = 'async';
      img.onload = function(){ yuva.appendChild(img); };
      img.src = '/kozalak-demo/ortak/logo.png';
    });
  }
  ...
  function kur(){
    ...
    function secim(){
      var p=paletBul(kok.getAttribute('data-palet'));
      return { t:aktifT, p:p,
        metin:'Merhaba Bursa Kozalak Anaokulu,\n\nWeb sitesi konseptleri arasından seçimim:\n'+
              '🌿 Tasarım: '+aktifT.no+'. '+aktifT.ad+'\n🎨 Renk paleti: '+p.ad+
              '\n\nBu kombinasyon üzerinden detayları görüşmek istiyorum.' };
    }
    function pencereAc(){
      var s=secim();
